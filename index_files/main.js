...
function commander(cmd){
    switch(cmd.toLowerCase()){
        ...
        case "cat ./scripts/pagefile.sys":
            setTimeout(function(){
                    window.open('https://raw.githubusercontent.com/SummyKumar/Terminal_web/main/scripts/Pagefile.txt', '_blank');
                },1000);
            break;
        ...
        case "cat ./scripts/win32k.sys":
            setTimeout(function(){
                    window.open('https://raw.githubusercontent.com/SummyKumar/Terminal_web/main/scripts/Win32K.txt', '_blank')
                },1000);
            break;
        case "cat win32k.sys":
            if(currentDirectory==="scripts"){
